...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1708: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1709: () => new TextDecoder("utf-8", {fatal: true}),
      _1710: () => new TextDecoder("utf-8", {fatal: false}),
      _1711: x0 => new WeakRef(x0),
      _1712: x0 => x0.deref(),
      _1718: Date.now,
      ...
      _1928: (o, p) => o[p],
      _1929: (o, p, v) => o[p] = v,
      _1930: (o, m, a) => o[m].apply(o, a),
      _1932: o => String(o),
      _1933: (p, s, f) => p.then(s, f),
      _1934: o => {

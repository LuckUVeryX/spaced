...
_1662: (decoder, codeUnits) => decoder.decode(codeUnits),
_1663: () => new TextDecoder("utf-8", {fatal: true}),
_1664: () => new TextDecoder("utf-8", {fatal: false}),
_1665: v => stringToDartString(v.toString()),
_1666: (d, digits) => stringToDartString(d.toFixed(digits)),
_1670: o => new WeakRef(o),
_1671: r => r.deref(),
_1676: Date.now,
_1678: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1679: s => {
...
_1689: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1690: s => printToConsole(stringFromDartString(s)),
_1699: (o, t) => o instanceof t,
_1701: f => finalizeWrapper(f,x0 => dartInstance.exports._1701(f,x0)),
_1702: f => finalizeWrapper(f,x0 => dartInstance.exports._1702(f,x0)),
_1703: o => Object.keys(o),
_1704: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_1705: (handle) => clearTimeout(handle),
_1706: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1707: (handle) => clearInterval(handle),
_1708: (c) =>
...
_1812: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1813: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1815: (s, m) => {
          try {
...
_1817: (x0,x1) => x0.test(x1),
_1818: (x0,x1) => x0.exec(x1),
_1819: (x0,x1) => x0.exec(x1),
_1820: x0 => x0.pop(),
_1824: (x0,x1,x2) => x0[x1] = x2,
_1826: o => o === undefined,
_1827: o => typeof o === 'boolean',
_1828: o => typeof o === 'number',
_1830: o => typeof o === 'string',
_1833: o => o instanceof Int8Array,
_1834: o => o instanceof Uint8Array,
_1835: o => o instanceof Uint8ClampedArray,
_1836: o => o instanceof Int16Array,
_1837: o => o instanceof Uint16Array,
_1838: o => o instanceof Int32Array,
_1839: o => o instanceof Uint32Array,
_1840: o => o instanceof Float32Array,
_1841: o => o instanceof Float64Array,
_1842: o => o instanceof ArrayBuffer,
_1843: o => o instanceof DataView,
_1844: o => o instanceof Array,
_1845: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1847: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1848: o => o instanceof RegExp,
_1849: (l, r) => l === r,
_1850: o => o,
_1851: o => o,
_1852: o => o,
...
_1854: o => o.length,
_1857: (o, i) => o[i],
_1858: f => f.dartFunction,
_1859: l => arrayFromDartList(Int8Array, l),
_1860: l => arrayFromDartList(Uint8Array, l),
_1861: l => arrayFromDartList(Uint8ClampedArray, l),
_1862: l => arrayFromDartList(Int16Array, l),
_1863: l => arrayFromDartList(Uint16Array, l),
_1864: l => arrayFromDartList(Int32Array, l),
_1865: l => arrayFromDartList(Uint32Array, l),
_1866: l => arrayFromDartList(Float32Array, l),
_1867: l => arrayFromDartList(Float64Array, l),
_1868: (data, length) => {
...
_1869: l => arrayFromDartList(Array, l),
_1870: stringFromDartString,
_1871: stringToDartString,
_1872: () => ({}),
_1873: () => [],
_1874: l => new Array(l),
_1875: () => globalThis,
